...
$supply_pestisida = mysqli_query($konek, "SELECT Tinggi from sensor WHERE ID>='$ID_awal' and ID<='$ID_akhir' ORDER BY ID ASC");
            ...
            datasets : [
                {
                    label : "Pestisida", 
                    fill : true,
                    backgroundColor: "rgba(0, 128, 0, 0.2)", // Warna hijau muda untuk mq131
